...
/***************----- W5500 GPIO定义 -----***************/
//sbit W5500_RST = P3^2;	//定义W5500的RST引脚
//sbit W5500_INT = P3^3;	//定义W5500的INT引脚
//sbit W5500_SCS = P3^6;	//定义W5500的CS引脚
//sbit W5500_SCLK = P3^7;	//定义W5500的SCLK引脚
//sbit W5500_MISO = P3^4;	//定义W5500的MISO引脚
//sbit W5500_MOSI = P3^5;	//定义W5500的MOSI引脚
/*

 #define W5500_RST 	ETH_NRST_BASE
 #define W5500_MOSI 	USER_SPI_MOSI_BASE
 #define W5500_SCS 	USER_SPI_CSN_BASE
 #define W5500_SCLK 	USER_SPI_SCLK_BASE
 #define W5500_MISO 	USER_SPI_MISO_BASE
 */

#define ETH_NRST_BASE	PIO_W5500_RESET_BASE
#define USER_SPI_MOSI_BASE PIO_SPI_MOSI_BASE
#define USER_SPI_CSN_BASE PIO_SPI_CSN_BASE
#define USER_SPI_SCLK_BASE PIO_SPI_SCLK_BASE
#define USER_SPI_MISO_BASE PIO_SPI_MISO_BASE
...
/***************----- 端口数据缓冲区 -----***************/
extern unsigned char Rx_Buffer[3000]; //端口接收数据缓冲区
extern unsigned char Tx_Buffer[3000]; //端口发送数据缓冲区
...
extern void Write_SOCK_Data_Buffer(SOCKET s, unsigned char *dat_ptr,
		unsigned short size); //指定Socket(0~7)发送数据处理
